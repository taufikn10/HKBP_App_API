...
class BodyRepeatPin extends StatefulWidget {
  const BodyRepeatPin({Key? key}) : super(key: key);

  @override
  State<BodyRepeatPin> createState() => _BodyRepeatPinState();
}

class _BodyRepeatPinState extends State<BodyRepeatPin> {
        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Padding(
                padding: const EdgeInsets.only(top: 47, bottom: 50),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    InputPin(
